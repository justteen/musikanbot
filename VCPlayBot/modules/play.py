...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nOr manually add assistant to your Group and try again manually request here @fmsasisten with your group link</b>",
                    )
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot not in this chat, Ask admin to send /play command for first time or add {user.first_name} manually request here @fmsasisten with your group link</i>"
        )
        return
    text_links=None
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/efa62bc524153f9dcdc8a.png"
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @Fmsmusicbot to your Group and try again manually request here @fmsasisten with your group link</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
        ...
        await lel.edit(
            "<i> helper Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually request here @fmsasisten with your group link</i>"
        )
        return
